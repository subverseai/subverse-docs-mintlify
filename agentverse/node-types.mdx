...
| Node | Description |
|---|---|
| [Slack](./nodes/slack.mdx) | Send messages, manage channels, and interact with Slack |
| [Airtable](./nodes/airtable.mdx) | Read, create, update, and delete Airtable records |
| [Shopify](./nodes/shopify.mdx) | Manage Shopify orders, products, customers, and inventory |
| [WhatsApp](./nodes/whatsapp.mdx) | Send WhatsApp messages and manage contacts |
| [Freshdesk](./nodes/freshdesk.mdx) | Manage Freshdesk support tickets, notes, and replies |
| [HTTP Request](./nodes/http-request.mdx) | Make HTTP calls to any external API |
| [Send Email](./nodes/email.mdx) | Send emails through any SMTP server |
| [File Upload](./nodes/file-upload.mdx) | Upload files to cloud storage (S3) |
| [Respond to Webhook](./nodes/respond-to-webhook.mdx) | Send a custom HTTP response back to a webhook caller |
