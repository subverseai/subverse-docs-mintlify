---
title: Airtable Token API Credentials
description: How to create and configure Airtable Token API credentials for SubverseAI
---
...
![Airtable Developer Hub](/images/credentials/airtable-personal-access-token-api.png)
*Create personal access tokens in the [Airtable Developer Hub](https://airtable.com/create/tokens)*
