...
<Warning>
**API Key only works for public sheets.** It does not support private sheets or any write operations (append, update, delete, create). For private sheets or write access, use the [Google Sheets Service Account](/credentials/types/google-sheets-service-account) or [Google Sheets OAuth2 API](/credentials/types/google-sheets-oauth2-api) credential type instead.
</Warning>

## Dashboard Screenshot

![Google Cloud Console](/images/credentials/google-sheet-api-key.png)
*Create API keys in the [Google Cloud Console](https://console.cloud.google.com/apis/credentials)*
