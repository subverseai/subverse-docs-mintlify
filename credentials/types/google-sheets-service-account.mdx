...
- Appending, updating, clearing, and deleting rows
- Creating new spreadsheets and adding sheets programmatically
- Secure, non-interactive authentication without user login

<Info>
  Other Google Sheets credential types are also available: [Google Sheets OAuth2 API](/credentials/types/google-sheets-oauth2-api) (sign in with your Google account) and [Google Sheets API Key](/credentials/types/google-sheets-api-key) (read-only, public sheets only).
</Info>
