...
description: How to create and configure HTTP Basic authentication credentials for SubverseAI
---
...
![API Service Dashboard](/images/credentials/http-basic-auth.png)
