---
title: JWT Auth Credentials
description: How to create and configure JWT authentication credentials for SubverseAI
---
...
![JWT Provider Dashboard](/images/credentials/jwt-auth.png)
